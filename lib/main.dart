    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        textTheme: const TextTheme(
          displaySmall: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, letterSpacing: -1.0),
          headlineMedium: TextStyle(color: Colors.white, fontWeight: FontWeight.w700, letterSpacing: -0.5, fontSize: 24),
          bodyMedium: TextStyle(color: Colors.white60, fontSize: 14, letterSpacing: 0.1),
          bodyLarge: TextStyle(color: Colors.white, fontSize: 16, letterSpacing: -0.2),
